...
![Image showing screws needed to disassemble device](./base_screws.jpeg)
...
Wire `GND`/`TX`/`RX` as with the other devices, but you'll also need a full RS232 serial adapter with DTR/RTS lines to get into programming mode, see "Entering Programming Mode" below.
...
![Connections used to read/write flash](https://github.com/user-attachments/assets/01225d19-d8fb-4e13-9001-dad6db352ce4)
